...
const Hero = () => {
  return (
    <section className="flex flex-col items-center justify-center w-full min-h-[80vh] md:min-h-screen px-4 sm:px-6 md:px-12 lg:px-24 text-center md:text-left py-12 ">
      <motion.p
